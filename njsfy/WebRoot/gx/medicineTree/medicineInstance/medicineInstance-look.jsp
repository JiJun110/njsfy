...
<div class="bjui-pageContent">
    <form action="<%=basePath%>njsfy-medicineInstance/medicineInstance-save.do?columnId=${columnId}" method="post" data-toggle="validate" data-reloadNavtab="false">
                ...
                <td style=" border: 0;" id="columnArticleTitlePicForm"  colspan="6">
                    <table width="90%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            ...
                            <td style=" border: 0;">
                                <button type="button" class="btn-blue" data-url="<%=basePath%>njsfy-medicineInstance/fileDownload-attach.do" data-toggle="doexportchecked" data-confirm-msg="确定要下载吗？" data-icon="download" data-idname="delids" data-group="ids">下载选中文件</button>
                            </td>
                        </tr>
                            <%--<td style=" border: 0;">
                          ...
                          <%--  <td style=" border: 0;">
                                <button type="button" class="btn-red" data-url="<%=basePath%>njsfy-medicineInstance/delete-attach.do" data-toggle="doajaxchecked" data-confirm-msg="确定要删除选中项吗？" data-icon="remove" data-idname="delids" data-group="ids" >删除选中文件</button>
                            </td>--%>
                    ...
                    <table id="tabelRe" class="table table-bordered table-hover table-striped table-top" >
                        <tbody id="tbBody">
                        <tr>
                            <td style=" border: 0;" width="5%" align="center"><input type="checkbox" class="checkboxCtrl" data-group="ids" data-toggle="icheck"></td>
