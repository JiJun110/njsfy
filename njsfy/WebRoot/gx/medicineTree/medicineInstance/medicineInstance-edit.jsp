...
<div class="bjui-pageContent">
    <c:set var="bol_c" scope="session" value="${bol}"/>
    <c:if test="${bol_c=='c'}">
            ...
            <table class="table table-condensed table-hover ">
                ...
                <tr>
                    ...
                    <td style=" border: 0;">
                        ...
                        <input type="text" name="medicineTypeName" readonly="readonly"
                               value="${medicineInstance.medicineTypeName}" data-toggle="lookup"
                               data-url="<%=basePath %>njsfy-medicineInstance/lookup-medicineType-list.do" size="20"
                               data-title="请选择章节:">
                    </td>
                    <td style=" border: 0;">
                ...
                <tr>
                    ...
                    <td style=" border: 0;" colspan="5">
                        <textarea name="warn" data-toggle="autoheight"
                                  style="width: 100%">${medicineInstance.warn}</textarea>
                    </td>
                </tr>
                <tr>
                    <td style=" border: 0;">
                    ...
                    <td style=" border: 0;" colspan="5">
                        <textarea name="syz" data-toggle="autoheight"
                                  style="width: 100%">${medicineInstance.syz}</textarea>
                    </td>
                </tr>
                <tr>
                    <td style=" border: 0;">
                    ...
                    <td style=" border: 0;" colspan="5">
                        <textarea name="yfyl" data-toggle="autoheight"
                                  style="width: 100%">${medicineInstance.yfyl}</textarea>
                ...
                <tr>
                    ...
                    <td style=" border: 0;">
                        <input type="radio" name="isGwy"
                               value="是"  ${medicineInstance.isGwy eq '是' ? 'checked="checked"':'' }
                               data-toggle="icheck" data-label="是">
                        <input type="radio" name="isGwy"
                               value="否"  ${medicineInstance.isGwy eq '否' ? 'checked="checked"':'' }
                               data-toggle="icheck" data-label="否">
                    ...
                    <td style=" border: 0;">
                        <input type="radio" name="isJy"
                               value="是"  ${medicineInstance.isJy eq '是' ? 'checked="checked"':'' } data-toggle="icheck"
                               data-label="是">
                        <input type="radio" name="isJy"
                               value="否"  ${medicineInstance.isJy eq '否' ? 'checked="checked"':'' } data-toggle="icheck"
                               data-label="否">
                    ...
                    <td style=" border: 0;">
                        <input type="radio" name="isPs"
                               value="是"  ${medicineInstance.isPs eq '是' ? 'checked="checked"':'' } data-toggle="icheck"
                               data-label="是">
                        <input type="radio" name="isPs"
                               value="否"  ${medicineInstance.isPs eq '否' ? 'checked="checked"':'' } data-toggle="icheck"
                               data-label="否">
                        <%--  <select name="isJy" data-toggle="selectpicker">
                              <option value="是" ${medicineInstance.isJy eq '是' ? 'selected="selected"':'' }>是</option>
                              <option value="否" ${medicineInstance.isJy eq '否' ? 'selected="selected"':'' }>否</option>
                ...
                <tr>
                    ...
                    <td style=" border: 0;" colspan="5">
                        <textarea name="tsCcTj" data-toggle="autoheight"
                                  style="width: 100%">${medicineInstance.tsCcTj}</textarea>
                    </td>
                ...
                <tr>
                    ...
                    <td style=" border: 0;" colspan="5">
                        <textarea name="cSmSy" data-toggle="autoheight"
                                  style="width: 100%">${medicineInstance.cSmSy}</textarea>
                    </td>
                </tr>
                ...
                <tr>
                    <td style=" border: 0;" id="columnArticleTitlePicForm" colspan="6">
                        <table width="90%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td style=" border: 0;"><label class="control-label x90"
                                                               style="width: 105px;">文件名称：</label></td>
                                <td style=" border: 0;">
                        ...
                        <table id="tabelRe" class="table table-bordered table-hover table-striped table-top">
                            <tbody id="tbBody">
                            <tr>
                                <td style=" border: 0;" width="5%" align="center"><input type="checkbox" name="ids"
                                                                                         class="checkboxCtrl"
                                                                                         data-group="ids"
                            ...
                            <c:forEach items="${fileRecordList}" var="fileRecord" varStatus="status">
                                <tr data-id="${fileRecord.rowId}">
                                    <td style=" border: 0;" align="center"><input type="checkbox" name="ids"
                                                                                  data-toggle="icheck"
